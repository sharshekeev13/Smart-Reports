...
class ListOfEmployeeDirectorAdapter( val onClickListener : (ListOfEmployeeModel)->Unit) : RecyclerView.Adapter<ListOfEmployeeDirectorAdapter.MyViewHolder>(), Filterable {
